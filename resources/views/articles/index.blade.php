        ...
        <div class="offset-lg-1 col-md-8">
            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    ...
                    <a class="text-decoration-none text-black" href="{{ route('articles.show', ['article' => $article]) }}">
                ...
                <div class="d-flex justify-content-left">
                    <a class="btn btn-info text-light" href="{{ route('articles.edit', ['article' => $article]) }}">Edytuj</a>
